// ============================================================
// CampusOS Shared Types — Domain Events
// Based on SDD §6 Event Architecture
// ============================================================
...
export interface UserLoggedInEvent extends DomainEventPayload {
  ...
  data: { userId: string; method: string; deviceInfo: string; ip: string };
}

export interface UserRegisteredEvent extends DomainEventPayload {
  eventType: 'user.registered';
  data: { userId: string; method: string; organizationId: string };
}

// ---- User Events ----
export interface UserCreatedEvent extends DomainEventPayload {
  eventType: 'user.created';
  data: { userId: string; role: string; organizationId: string; branchId: string };
}
