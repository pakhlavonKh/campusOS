...
export declare enum HomeworkLatePolicy {
    ACCEPT = "accept",
    DEDUCT = "deduct",
    REJECT = "reject"
}
...
export declare enum CompletionEntityType {
    LESSON = "lesson",
    MODULE = "module",
    COURSE = "course"
}
export declare enum AntiCheatLevel {
    NONE = "none",
    BASIC = "basic",
    STANDARD = "standard",
    STRICT = "strict",
...
export declare enum AttendanceStatusType {
    PRESENT = "present",
    ABSENT = "absent",
    LATE = "late",
    EXCUSED = "excused"
}
export declare enum GradeScaleType {
    LETTER = "letter",
